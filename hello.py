...
#read groupes
	document_path = os.getcwd()+'/dictionnaries/groupe.txt'
...
#read Verbes
	document_path = os.getcwd()+'/dictionnaries/verbe.txt'
	with open(document_path, 'r') as f:
		reader = csv.reader(f, delimiter='\t')
...
#read des mots pour dire "musique"
	document_path = os.getcwd()+'/dictionnaries/musique.txt'
	with open(document_path, 'r') as f:
		reader = csv.reader(f, delimiter='\t')
...
#read des adjectifs pour qualifier la musique
	document_path = os.getcwd()+'/dictionnaries/adj.txt'
	with open(document_path, 'r') as f:
		reader = csv.reader(f, delimiter='\t')
		adjSyn = (list(reader))
